          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                ...
                <li><strong>Sumber daya Desa </strong>: <a href="{{ $related_galeri->sumber_daya }}">{{ $related_galeri->sumber_daya }}</a></li>
              </ul>
            </div>
              ...
              <script>
                @foreach($related_galeris as $realated_galeri)
                  ...
                  L.tileLayer('https://tile.openstreetmap.org/{z}/{x}/{y}.png', {
                      ...
                      .bindPopup("{{ $related_galeri->nama_desa }}, <br>{{ $related_galeri->alamat }},<br>Bandung {{ ucwords($related_galeri->provinsi) }}")
                      .openPopup();
                  @endforeach
              </script>
